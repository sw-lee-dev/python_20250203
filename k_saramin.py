...
# print(len(recruit_items)) 정보들을 다 가져오는 것 확인
main_items = []

for recruit_items in recruit_items:
    job_tit = recruit_items.find_element(By.CLASS_NAME, 'job_tit')
    a = job_tit.find_element(By.TAG_NAME, 'a')
    title = a.get_attribute("title")
    url = a.get_attribute("href")

    corp_name = recruit_items.find_element(By.CLASS_NAME, 'corp_name')
